...
// node_modules/@codemirror/state/node_modules/@marijn/find-cluster-break/src/index.js
var rangeFrom = [];
var rangeTo = [];
(() => {
...
// node_modules/@codemirror/view/node_modules/style-mod/src/style-mod.js
var C = "ͼ";
...
// node_modules/@codemirror/view/node_modules/w3c-keyname/index.js
var base = {
  8: "Backspace",
  9: "Tab",
  10: "Enter",
...
// node_modules/@codemirror/view/node_modules/crelt/index.js
function crelt() {
  var elt = arguments[0];
...
// node_modules/@codemirror/language/node_modules/style-mod/src/style-mod.js
var C2 = "ͼ";
...
var StyleModule2 = class {
  ...
  // the `<style>` tag generated by the library.
  static mount(root, modules, options) {
    let set = root[SET2], nonce = options && options.nonce;
    if (!set)
      set = new StyleSet2(root, nonce);
    else if (nonce)
      set.setNonce(nonce);
    set.mount(Array.isArray(modules) ? modules : [modules], root);
  }
...
//# sourceMappingURL=chunk-LTQWNZBW.js.map
