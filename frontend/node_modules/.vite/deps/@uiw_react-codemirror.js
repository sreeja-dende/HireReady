...
// node_modules/@uiw/codemirror-extensions-basic-setup/node_modules/crelt/index.js
function crelt() {
  var elt = arguments[0];
...
// node_modules/@uiw/codemirror-extensions-basic-setup/node_modules/@codemirror/search/dist/index.js
...
// node_modules/@codemirror/lint/node_modules/crelt/index.js
function crelt2() {
  var elt = arguments[0];
  if (typeof elt == "string")
    elt = document.createElement(elt);
...
function diagnosticsTooltip(view, diagnostics) {
  return crelt2("ul", { class: "cm-tooltip-lint" }, diagnostics.map((d) => renderDiagnostic(view, d, false)));
}
...
function renderDiagnostic(view, diagnostic, inPanel) {
  ...
  return crelt2("li", { class: "cm-diagnostic cm-diagnostic-" + diagnostic.severity }, crelt2("span", { class: "cm-diagnosticText" }, diagnostic.renderMessage ? diagnostic.renderMessage(view) : diagnostic.message), (_a = diagnostic.actions) === null || _a === void 0 ? void 0 : _a.map((action, i) => {
    ...
    let nameElt = keyIndex < 0 ? name : [
      ...
      crelt2("u", name.slice(keyIndex, keyIndex + 1)),
      name.slice(keyIndex + 1)
    ];
    let markClass = action.markClass ? " " + action.markClass : "";
    return crelt2("button", {
      type: "button",
  ...
  }), diagnostic.source && crelt2("div", { class: "cm-diagnosticSource" }, diagnostic.source));
}
var DiagnosticWidget = class extends WidgetType {
  ...
  toDOM() {
    return crelt2("span", { class: "cm-lintPoint cm-lintPoint-" + this.sev });
  }
};
var PanelItem = class {
...
var LintPanel = class _LintPanel {
  constructor(view) {
    ...
    this.dom = crelt2("div", { class: "cm-panel-lint" }, this.list, crelt2("button", {
      type: "button",
      name: "close",
